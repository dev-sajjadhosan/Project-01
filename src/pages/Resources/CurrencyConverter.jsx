...
const CurrencyConverter = () => {
  return (
    <>
      <section className="p-5 md:p-15">
        <div className="card gap-1 md:w-1/2">
          <h1 className="text-2xl md:text-5xl capitalize">
            currency converter
          </h1>
        ...
        <div className="mt-15">
          ...
          <p className="text-sm font-light tracking-wide text-gray-500 mt-3">
        ...
        <div className="mt-15 lg:w-1/2 mx-auto text-center">
          <h2 className="text-4xl">How to use the currency converter</h2>
          <p className="text-sm font-light tracking-wide mt-1.5">
